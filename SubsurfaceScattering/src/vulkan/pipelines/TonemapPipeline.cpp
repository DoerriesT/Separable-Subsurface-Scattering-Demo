...
std::pair<VkPipeline, VkPipelineLayout> sss::vulkan::TonemapPipeline::create(VkDevice device, VkRenderPass renderPass, uint32_t subpassIndex, uint32_t setLayoutCount, VkDescriptorSetLayout * setLayouts)
{
	VkPipelineLayout pipelineLayout;

	VkPushConstantRange pushConstantRange{ VK_SHADER_STAGE_FRAGMENT_BIT, 0, sizeof(PushConsts) };
	...
	ShaderModule vertexShaderModule(device, "resources/shaders/fullscreen_vert.spv");
	ShaderModule fragmentShaderModule(device, "resources/shaders/tonemap_frag.spv");
